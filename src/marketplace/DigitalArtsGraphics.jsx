...
const DigitalArtsGraphics = () => {
    ...
    const getAllProduct = async () => {
        try {
            const response = await networkRequest("GET", API_ENDPOINTS.GET_ALL_PRODUCT, {}, {}, { category: "digital arts graphics" });
    ...
    const handleApplyFilters = async () => {
        ...
        filteredData.category = "digital arts graphics"
        try {
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-9 col-lg-8">
                            <div className="head-area mb-5">
                                <h6>All Digital Arts & Graphics Products</h6>
                            </div>
...
export default DigitalArtsGraphics;
