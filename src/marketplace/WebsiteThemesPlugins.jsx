...
const WebsiteThemesPlugins = () => {
    ...
    const getAllProduct = async () => {
        try {
            const response = await networkRequest("GET", API_ENDPOINTS.GET_ALL_PRODUCT, {}, {}, { category: "website theme plugins" });
    ...
    const handleApplyFilters = async () => {
        ...
        filteredData.category = "website theme plugins"
        try {
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-9 col-lg-8">
                            <div className="head-area mb-5">
                                <h6>All Website Theme Plugins Products</h6>
                            </div>
...
export default WebsiteThemesPlugins;
