...
const DigitalTemplates = () => {
    ...
    const getAllProduct = async () => {
        try {
            const response = await networkRequest("GET", API_ENDPOINTS.GET_ALL_PRODUCT, {}, {}, { category: "digital templates" });
    ...
    const handleApplyFilters = async () => {
        ...
        filteredData.category = "digital templates"
        try {
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-9 col-lg-8">
                            <div className="head-area mb-5">
                                <h6>All Digital Templates Products</h6>
                            </div>
