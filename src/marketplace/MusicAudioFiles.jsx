...
const MusicAudioFiles = () => {
    ...
    const getAllProduct = async () => {
        try {
            const response = await networkRequest("GET", API_ENDPOINTS.GET_ALL_PRODUCT, {}, {}, { category: "music audio files" });
    ...
    const handleApplyFilters = async () => {
        ...
        filteredData.category = "music audio files"
        try {
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-9 col-lg-8">
                            <div className="head-area mb-5">
                                <h6>All Music Audio Files Products</h6>
                            </div>
...
export default MusicAudioFiles;
