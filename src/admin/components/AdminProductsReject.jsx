...
const AdminProductsReject = () => {
    ...
    const getAllProducts = async () => {
        try {
            const response = await networkRequest("GET", API_ENDPOINTS.GET_ALL_PRODUCT, {}, {}, { status: "reject" });
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 className="mb-sm-0 font-size-18">All Reject Products</h4>
                                </div>
                            </div>
                        </div>
                        <div className="row">
...
export default AdminProductsReject;