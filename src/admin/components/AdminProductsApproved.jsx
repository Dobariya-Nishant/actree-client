...
const AdminProductsApproved = () => {
    ...
    const getAllProducts = async () => {
        try {
            const response = await networkRequest("GET", API_ENDPOINTS.GET_ALL_PRODUCT, {}, {}, { status: "approved" });
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 className="mb-sm-0 font-size-18">All Approved Products</h4>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                                            ...
                                            <div className="col-sm-4">
                                                <div className="search-box me-2 mb-2 d-inline-block">
                                                    <div className="position-relative">
                                                        <h4 className="mb-sm-0 font-size-18">Product List</h4>
                                                    </div>
                                                </div>
                                            </div>
...
export default AdminProductsApproved;