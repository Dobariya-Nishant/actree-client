                        ...
                        <div className="col-xxl-6 col-xl-5 col-lg-8 mt-0 mt-lg-10 mt-xl-0 d-flex flex-column gap-7 cus-z">
                            ...
                            <div className="post-item d-flex flex-column gap-5 gap-md-7" id="news-feed">
                                <div className="post-single-box p-3 p-sm-5">
                                    <h6>What’s your advertising goal?</h6>

                                    <div className="ad-goals-container">
                                        <div className="ad-goals-grid">
                                            <label className="goal-card">
                                                <div className="goal-content">
                                                    <input type="radio" name="adGoal" value="Reach" />
                                                    <img src="assets/images/ads/reach.png" alt="Reach" className="goal-icon" />
                                                    <h5>Reach</h5>
                                                    <p>Show my ad to as many people as possible.</p>
                                                </div>
                                            </label>

                                            <label className="goal-card">
                                                <div className="goal-content">
                                                    <input type="radio" name="adGoal" value="Engagements" />
                                                    <img src="assets/images/ads/engagement.png" alt="Engagements" className="goal-icon" />
                                                    <h5>Engagements</h5>
                                                    <p>Get more likes, shares, and comments.</p>
                                                </div>
                                            </label>

                                            <label className="goal-card">
                                                <div className="goal-content">
                                                    <input type="radio" name="adGoal" value="Website Traffic" className="gci" />
                                                    <img src="assets/images/ads/traffic.png" alt="Website Traffic" className="goal-icon" />
                                                    <h5>Website Traffic</h5>
                                                    <p>Drive visitors to my website.</p>
                                                </div>
                                            </label>

                                            <label className="goal-card">
                                                <div className="goal-content">
                                                    <input type="radio" name="adGoal" value="Promote My Product" />
                                                    <img src="assets/images/ads/product.png" alt="Promote My Product" className="goal-icon" />
                                                    <h5>Promote My Product</h5>
                                                    <p>Increase visibility & sales for marketplace listings.</p>
                                                </div>
                                            </label>
                                        </div>
                                        ...
                                        {/* <div className="goal-card lead-card">
                                            <div className="goal-content">
                                                <img src="assets/images/ads/lead.png" alt="Lead Generation" className="goal-icon" />
                                                <div className="lead-texts">
                                                    <h5>Lead Generation</h5>
                                                    <p>Get Leads through an AI lead form</p>
                                                </div>
                                                ...
                                                <div className="avatar-item d-flex gap-3 align-items-center">
                                                    <div className="position-relative">
                                                        <img
                                                            ...
                                                            src="assets/images/ads/lead.png"
                                                            alt="avatar"
                                                        />
                                                    </div>
                                                    <div className="info-area">
                                                        <h6 className="m-0">Lead Generation</h6>
                                                        <span className="mdtxt status">Get Leads through an AI lead form</span>
                                                    </div>
                                                </div>
