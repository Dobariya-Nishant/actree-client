  ...
  jQuery(document).ready(function () {
    ...
    $(".story-carousel")
      ...
      .slick({
        ...
        arrows: true,
        prevArrow:
          "<button type='button' class='arafat-prev cmn-btn pull-left'><i class=\"material-symbols-outlined mat-icon\"  aria-hidden='true'>chevron_left</i></button>",
        nextArrow:
          "<button type='button' class='arafat-next cmn-btn pull-right'><i class=\"material-symbols-outlined mat-icon\"  aria-hidden='true'>chevron_left</i></button>",
        dots: false,
    ...
    if (document.querySelector("#memberRequest") !== null) {
      ...
      var chart = new ApexCharts(
        document.querySelector("#memberRequest"),
        options
      );
      chart.render();
    }
    ...
    if (document.querySelector("#postContentOne") !== null) {
      ...
      var chart = new ApexCharts(
        document.querySelector("#postContentOne"),
        options
      );
      chart.render();
    }
    ...
    if (document.querySelector("#postContentTwo") !== null) {
      ...
      var chart = new ApexCharts(
        document.querySelector("#postContentTwo"),
        options
      );
      chart.render();
    }
    ...
    if (document.querySelector("#postContentThree") !== null) {
      ...
      var chart = new ApexCharts(
        document.querySelector("#postContentThree"),
        options
      );
      chart.render();
    }
